describe Chess::Board do
  describe '#algebraic' do
    ...
    it 'returns the correct algebraic equivalent of a square' do
      Chess::Board::SQUARES.each do |square, sqi|
        expect(chess.algebraic(sqi).to_sym).to eq(square)
      end
    end
  end
#
...
#    let(:chess) { Chess::Board.new }
#
#    it 'returns square keys' do
#      expect(chess.squares.first).to eq(:a8)
#    end
#  end
#
#  describe '#get' do
